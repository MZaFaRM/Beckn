...
<details>
<summary>Role-wise API Endpoint Summary</summary>
</details>

<details>
<summary>Beckn Application Platform (BAP)</summary>
...
<details>
<summary>Beckn Gateway (BG)</summary>
...
<details>
<summary>Beckn Provider Platform (BPP)</summary>
...
### 5. 📤 Sample Payloads (Excerpt)

#### `search` Request

```json
{
  "context": { "domain": "agri.soil_testing", ... },
  "message": {
    "intent": {
      "item": { "descriptor": { "name": "Soil Testing" } },
      "fulfillment": {
        "end": { "location": { "gps": "19.9975,73.7898" } }
      }
    }
  }
}
      ...
      "providers": [
        {
          ...
          "descriptor": { "name": "Krishi Kendra Soil Services" },
          "items": [{ "id": "soil-npk", "descriptor": { "name": "NPK Test" } }],
          "fulfillments": [{ "type": "home_pickup" }]
        }
      ]
    }
  }
